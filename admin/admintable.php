...
include'header.php';                               
        ...
        <div class="content">
            <div class="container-fluid">
                         ...
                         <div float="rigt">  <form action="exporter.php" method="POST">
                                      <div class="col-md-2">
                                            <div class="form-group" float="pull-right">
                                             
                                                 <input type="submit" name='export' value="Export to Excel" class="btn btn-info btn-fill">
                                            </div>
                                        </div>
                                        </form>  </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="">Anand Saurav</a>
                </p>
            </div>
        </footer>
