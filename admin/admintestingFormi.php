...
<div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div>
               <input type="submit" value="Add Products Using Excel" name="add_excel" class="btn btn-info btn-lg btn-block btn-fill pull-middle" onclick="window.location.href = 'http://localhost/myskugenerator/admin/adminimport.php'">
                    </div>
               </div>
...
*/
                  ...
                  //  echo $image;
                    ...
                    if (isset($_POST['submit_11'])) {
                          ...
                          $sql="INSERT INTO `item_list` (main_category,main_code,sub_category,sub_code,item_name,item_code,brand_name,brand_code,sku_number) VALUES('".$main_category."','".$m_code."','".$sub_category."','".$s_code."','".$item_name."','".$item_code."','".$brand_name."','".$b_code."','".$sku_number."') ";
                    ...
                    $run=mysqli_query($con,$sql_1) or die(mysqli_error($con ));
                       ...
                       if ($run) {
                        echo "<script>
                             ...
                             window.location.href = 'http://localhost/myskugenerator/admin/admintestingFormi.php';
